...
public class EditEmployeeDialog extends javax.swing.JDialog {
    ...
    public EditEmployeeDialog(java.awt.Frame parent, boolean modal, 
            JTable table, String type, Connection conn ) {
        super(parent, modal);
        
        //get the references to the conn
        this.conn = conn;
        ...
        //the row that we selected to edit
        int row = table.getSelectedRow();
        
        //setup the text field dialog
        ...
        positionTF.setText((String)table.getValueAt(row,3) );
        try {
        ...
        phoneTF.setText((String)table.getValueAt(row,5));
        birthPlaceTF.setText((String)table.getValueAt(row,7) );
        commentTA.setText((String)table.getModel().getValueAt(row,8));
        
        //setup the type combobox
        TypeCoB.setSelectedItem( type );
    
        //parse beautiful string to date
        DateFormat df = DateFormat.getDateInstance(
                        DateFormat.LONG, Locale.ENGLISH );
        try {
            birthDateChooser.setDate( df.parse( (String)table.getValueAt(row,6) ) );
        }
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        //must use the employee class to do operation
        EmployeeDB st = new EmployeeDB(conn);
        boolean result = st.updateEmployee( table, number, name, address, 
                position, Integer.parseInt(salary), phone,  
                new Date(birthDateChooser.getDate().getTime()), birthplace, comment, type );
        
        //error editing employee
        if(!result)
            JOptionPane.showMessageDialog(null,"Error editing employee data! See log file " +
...
//            public void run() {
//                new EditEmployeeDialog(new javax.swing.JFrame(), true, null, null, conn)
