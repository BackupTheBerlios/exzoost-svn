...
public class EditCustomerDialog extends javax.swing.JDialog {
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        //must use the customer class
        CustomerDB st = new CustomerDB(conn);
        boolean result = st.updateCustomer( table, name, address, phone, comment );
        
        //error inserting customer
        if(!result)
            JOptionPane.showMessageDialog(null,"Error editing customer data! See log file " +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddCustomerDialog(new javax.swing.JFrame(), true, null, 
