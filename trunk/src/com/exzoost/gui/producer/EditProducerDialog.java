 ...
 * @author  knight
 */
public class EditProducerDialog extends javax.swing.JDialog {
    private Connection conn;
    /** Creates new form AddSellerDialog */
    public EditProducerDialog(java.awt.Frame parent, boolean modal, 
            JTable table, Connection conn ) {
        super(parent, modal);
        
        //must use the conn reference
        this.conn = conn;
        ...
        //must use the table reference
        this.table = table;
        
        //Setup the dialog text field
        NameTF.setText((String)table.getValueAt(table.getSelectedRow(),0));
        if(table.getValueAt(table.getSelectedRow(),1)!=null)
            AddressTA.setText((String)table.getValueAt(table.getSelectedRow(),1));
        if(table.getValueAt(table.getSelectedRow(),2)!=null)
            TelephoneTF.setText((String)table.getValueAt(table.getSelectedRow(),2));
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        String phone = TelephoneTF.getText().trim();
        ...
        boolean result = st.updateProducer( table, name, address, phone, comment );
        
        //error inserting producer
        if(!result)
            JOptionPane.showMessageDialog(null,"Error editing producer data! See log file " +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditProducerDialog(new javax.swing.JFrame(), true, null, 
