...
public class BuyReport extends javax.swing.JDialog {
    private Connection conn;
    private InventoryDB inventory;
    /** Creates new form CustomersReport */
    public BuyReport(java.awt.Frame parent, boolean modal, 
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        if(DetailBasic.isSelected()&&ReportTabbedPane.getSelectedIndex()!=2) {
            JTable table = rm.ItemsDetailReport( fromdate, todate, "buy" );
            ...
            String title = "The Purchase Transaction Between " + 
            ...
            if(ReportTabbedPane.getSelectedIndex()==2) {
                chartpanel = rm.ItemProgressChartReport( fromdate, todate, (String)ItemCoB.getSelectedItem(),
                        (String)ReportCoB.getSelectedItem(), "buy" );
                scrollpane.setViewportView(chartpanel);
            }
            else {
                chartpanel = rm.ItemsTransPieReport( fromdate, todate,
                            (String)PieChartComboBox.getSelectedItem(), "buy" );    
                scrollpane.setViewportView(chartpanel);
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SaleReport(new javax.swing.JFrame(), true, new javax.swing.JPanel(), null).setVisible(true);
            }
        });
    }
