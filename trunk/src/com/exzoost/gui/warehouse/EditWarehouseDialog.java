...
package com.exzoost.gui.warehouse;
...
public class EditWarehouseDialog extends javax.swing.JDialog {
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        boolean result = warehousedb.updateWarehouse(table, name, address, comment ); 
        
        //error editing warehouse data
        if(!result)
            JOptionPane.showMessageDialog(null,"Error editing warehouse data! See log file " +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditWarehouseDialog(new javax.swing.JFrame(), true, 
