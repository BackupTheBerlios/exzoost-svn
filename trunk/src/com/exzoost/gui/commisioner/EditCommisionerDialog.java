 ...
 * @author  knight
 */
public class EditCommisionerDialog extends javax.swing.JDialog {
    private Connection conn;
    /** Creates new form AddSellerDialog */
    public EditCommisionerDialog(java.awt.Frame parent, boolean modal, 
        ...
        addressTA.setText((String)table.getValueAt(row,1));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        SellerPanel.setBorder(new javax.swing.border.TitledBorder(null, "Commisioner", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 11)));
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        //must use the commisioner class
        CommisionerDB st = new CommisionerDB(conn);
        boolean result = st.updateCommisioner( table, name, address, phone, comment );
        
        //error editing commisioner
        if(!result)
            JOptionPane.showMessageDialog(null,"Error editing commisioner data! See log file " +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddCommisionerDialog(new javax.swing.JFrame(), true, null, null).setVisible(true);
            }
        });
    }
