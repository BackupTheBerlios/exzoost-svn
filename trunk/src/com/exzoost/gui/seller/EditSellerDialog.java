package com.exzoost.gui.seller;
/*
...
public class EditSellerDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        SellerPanel.setBorder(new javax.swing.border.TitledBorder("Suplier"));
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        SellerDB st = new SellerDB(conn);
        boolean result = st.updateSeller( table, name, address, phone, comment );
        
        //error editing suplier
        if(!result)
            JOptionPane.showMessageDialog(null,"Error editing suplier data! See log file " +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSellerDialog(new javax.swing.JFrame(), true, null, 
