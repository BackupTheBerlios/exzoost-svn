...
public class AddSellerDialog extends javax.swing.JDialog {
    ...
    public AddSellerDialog(java.awt.Frame parent, boolean modal, 
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        boolean result = st.insertSeller( table, name, address, phone, comment );
        
        //error inserting suplier
        if(!result)
            JOptionPane.showMessageDialog(null,"Error adding suplier data! See log file " +
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSellerDialog(new javax.swing.JFrame(), true, null, 
